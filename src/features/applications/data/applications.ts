...
export const applicationsMock: Application[] = [
  ...
  },
  {
    ...
    field: APPLICATION_FIELDS[1 % APPLICATION_FIELDS.length]!,
    status: 'rejected',
  ...
  },
  {
    ...
    field: APPLICATION_FIELDS[4 % APPLICATION_FIELDS.length]!,
    status: 'in-progress',
  ...
  },
  {
    ...
    field: APPLICATION_FIELDS[3 % APPLICATION_FIELDS.length]!,
    status: 'in-progress',
  ...
  },
  {
    ...
    field: APPLICATION_FIELDS[5 % APPLICATION_FIELDS.length]!,
    status: 'interview',
